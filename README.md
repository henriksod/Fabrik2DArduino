...
| Method | Description |
| --- | --- |
| ```cpp Fabrik2D(int numJoints, int* lengths)``` | The constructor of the class. Here you specify the number of joints (which cannot be changed) and the array of lengths which is always one less than the number of joints. |
